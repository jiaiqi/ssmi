      ...
      <table v-if="tabsData&&tabsData.length>0">
        <tbody>
          ...
          <el-dialog :visible.sync="dialogVisible" width="1000px">
            ...
            <div class="zyzllclj">
              <div class="title"></div>
              <div class="little_title">病程记录</div>
              <div class="bcjl_head">
              ...
              <div class="bcjl_content">
                ...
                <div class="main_content">患者 {{ detail.DE02_01_039_00 }} ，{{ detail.DE02_01_032_00 }} 岁，因 {{ detail.AP05_01_215_02}} 于 {{format_date(detail.AP05_01_212_00)}} 入院</div>
