  ...
  <div class="tablebox">
    <div class="tabletop">
      <ul>
        ...
        <li class="lilast">2019/4/20 10:32:38</li>
      </ul>
    </div>
      ...
      <div class="databox_content">
        ...
        <div class="databox_three">
          ...
          <div class="databox_three_content">
            ...
            <ul class="databox_three_contentdata1">
              <li>Mysql</li>
              <li>√</li>
              <li>×</li>
              <li>√</li>
            ...
            <ul class="databox_three_contentdata2">
              <li>MongoDB</li>
              <li>√</li>
              <li>×</li>
              <li>√</li>
...
export default {
  methods: {
    ...
    getData() {
      ...
      axios.post(
        'http://192.168.0.192:8101/datacenter/select/srvetl_job_history_select', params, {          headers: {
            'bx_auth_ticket': 'ce4f2ddc-4526-4498-852d-8372da40713f'
          }        }
      ).then(res => {
        console.log(res)
      }).catch(err => {
